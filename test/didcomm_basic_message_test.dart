  ...
  group('Basic Message module', () {
    test('should create, pack, and unpack  a basicmessage correctly', () async {
      ...
      final Map<String, dynamic> packAuthMsg = packAuthCrypt(
        senderPrivKeyStr: "privBve6bpkpdM4jHTkNnDRbVg8DYtizNubhzaYtD37GHsvFghckrNDm",
      ...
      final Map<String, dynamic> unpackAuthMsg = unpackAuthCrypt(
        jwe: packAuthMsg,
        receiverPrivKeyStr: "privBtpaUECfDNku8K8RJgGptKRL24c365AbFHXEctRMDJGTntWkPmJD",
      ...
      expect(unpackAuthMsg['type'], equals("https://didcomm.org/basicmessage/2.0/message"));
    });
  });
}
